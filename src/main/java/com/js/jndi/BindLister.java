...
/*
 * Demonstrates how to list a context using arguments supplied CLI.
 *
 * Usage: java -jar bind-lister.jar "file:///\\C:\\Temp"
 */
public class BindLister {
    public String getGreeting() {
        return "Running JNDI Bind lister...";
    }

    public static void main(String [] rgstring) {

        System.out.println(new BindLister().getGreeting());
        ...
        try {
            ...
            hashtableEnvironment.put(
                    Context.PROVIDER_URL, rgstring[0]
            );
